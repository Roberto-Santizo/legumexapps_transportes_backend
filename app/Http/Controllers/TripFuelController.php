...
class TripFuelController extends Controller
{
    ...
    #[OA\Post(
        ...
        responses: [
            ...
            new OA\Response(
                response: 403,
                description: 'Sin permiso para registrar. TRES CAUSAS DISTINTAS con mensajes distintos: el middleware role:carrier,administrator rechaza a manager, pilot, export, user y shipment con «No tienes permisos para acceder a este recurso»; un carrier que todavía no ha registrado su empresa recibe del service «No perteneces a ninguna empresa transportista»; y un carrier cuya empresa no tomó el viaje —INCLUIDO EL CASO DE UN VIAJE SIN ASIGNAR, que sí se puede leer— recibe «No puedes registrar combustible en un viaje que no tomó tu empresa transportista».',
                content: new OA\JsonContent(ref: '#/components/schemas/ApiError'),
            ),
            new OA\Response(
                response: 404,

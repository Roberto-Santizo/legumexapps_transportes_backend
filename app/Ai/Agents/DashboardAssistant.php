 ...
 * prompt of the turn. Nothing is persisted, which is why the agent does not use
...
class DashboardAssistant implements Agent, Conversational, HasTools
{
    ...
    private function promptTemplate(): string
    {
        return <<<'PROMPT'
            Eres el asistente del tablero de Legumex Transportes, una plataforma interna de transporte de exportación en Guatemala. Respondes preguntas sobre viajes, flota y gastos de mantenimiento usando exclusivamente los datos que devuelven tus herramientas.
                ...
                - No modificas datos: si te piden crear, asignar, editar o borrar algo, indica que el asistente solo consulta y genera reportes, y que esa acción se hace desde la pantalla correspondiente. Lo único que produces son archivos Excel de reporte, con los datos que ya puedes consultar y dentro de tu mismo ámbito.
    ...
    public function tools(): iterable
    {
        ...
        $reports = app(ReportServiceInterface::class);

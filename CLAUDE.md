...
- Fuera: envío push, limpieza de tokens inválidos por respuesta de FCM, purga por `last_seen_at`, `GET` de tokens, límite por usuario, Web Push/APNs directo, `/logout` y preferencias de notificación.
